...
async function loadDashboard() {
  try {
    ...
    document.getElementById("cartCount").innerHTML = data.cart;

    document.getElementById("orderCount").innerHTML = data.orders;

    document.getElementById("deliveryCount").innerHTML = data.deliveries;

    document.getElementById("spentAmount").innerHTML = "Rs. " + data.spent;
  } catch (error) {
    console.log(error);
  }
}
